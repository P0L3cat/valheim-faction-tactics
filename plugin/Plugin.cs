    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            if (PluginConfig.EnablePlugin.Value)
            {
                ...
                Log.LogInfo($"{PluginName} {PluginVersion} loaded (1.0.12 aggression: Attack→vanilla UpdateAI; hungrier skeleton flankers / greydwarfs / draugr). Tick={PluginConfig.TickIntervalSeconds.Value}s");
            }
            else
            {
