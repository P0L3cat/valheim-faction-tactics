    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            if (PluginConfig.EnablePlugin.Value)
            {
                ...
                Log.LogInfo($"{PluginName} {PluginVersion} loaded (1.0.13 always-threat: ceil(10%) Attack or ranged harass while engaged/Theater). Tick={PluginConfig.TickIntervalSeconds.Value}s");
            }
            else
            {
